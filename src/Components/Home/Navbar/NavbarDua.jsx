...
const NavbarDua = () => {
  ...
  return (
      <nav className="Navbar-wrappers text-white">
        <div className="max-w-7xl mx-3 md:mx-6 lg:mx-auto">
          <div className="flex mx-auto justify-between  ">
            {/* Primary menu and logo */}
            <div className="flex items-center gap-8 lg:gap-12 my-0 lg:my-2">
              {/* logo */}
        ...
        >
          <div className="px-8 py-4">
            ...
            <div className="my-2 flex flex-wrap">
              <button className="btn-one px-4 py- bg-yellow-300 hover:bg-yellow-400 text-gray-900 font-bold rounded">
                  Build Your Team
              </button>
              <button className="px-4 py-4">
                <span className="border px-4 py-2  border-yellow-300 text-yellow-300 hover:bg-yellow-400 rounded  w-full">Apply as a talent</span>
